...
apt install -y wget curl git build-essential libicu-dev zlib1g zlib1g-dev unzip
echo 'export DOTNET_ROOT=$HOME/.dotnet' >> ~/.bashrc
echo 'export PATH=$PATH:$HOME/.dotnet:$HOME/.dotnet/tools' >> ~/.bashrc
source ~/.bashrc
wget https://github.com/AITYunivers/NebulaFD/releases/download/general_patches/Nebula.general_patches.zip
unzip Nebula.general_patches.zip -d ~/NebulaRelease
cd ~/NebulaRelease
